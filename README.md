...
Early development. This repo currently has the Phase 0 project scaffold (Vite + React, `pixelloom` wired up and tracing correctly) — the actual editor doesn't exist yet.
